...
def generate_launch_description():
    ...
    #lidar_flip = IncludeLaunchDescription(
        #PythonLaunchDescriptionSource([get_package_share_directory("lidar_flip"), "/launch/lidar_flip.launch.py"])
    #)
    ...
    #qos_reliability_arg = DeclareLaunchArgument(
     ...
     #   description='QoS reliability setting for pointcloud_to_laserscan node'
    #)
      ...
      #  executable='pointcloud_to_laserscan_node',
       # remappings=[('cloud_in', [LaunchConfiguration(variable_name='scanner'), '/pointcloud']),
        ...
        #parameters=[{
         ...
         #   'use_inf': True,
        #    'inf_epsilon': 1.0,
       #     'qos_overrides./parameter_events.publisher.reliability': LaunchConfiguration(variable_name='qos_reliability')
      #  }],
